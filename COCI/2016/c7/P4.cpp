...
struct num {
    ...
    bool operator>(const num& other) const {
        ll mn = min(b, other.b);
        if(b > other.b && b - other.b > 32) return 1;
        if(other.b > b && other.b - b > 32) return 0;
        return a * (1ll << (b - mn)) > other.a * (1ll << (other.b - mn));
    }
} dp[N];
