...
#define rc (rt << 1 | 1)
    void build(int rt, int l, int r) {
        if(l == r) {
            switch (s[l]) {
                case 'a': st[rt] = A; break;
                case 'b': st[rt] = B; break;
                case 'c': st[rt] = C; break;
            }
            return;
        }
        int mid = l + r >> 1;
    ...
    void update(int rt, int l, int r, int pos, char val) {
        if(l == r) {
            switch (val) {
                case 'a': st[rt] = A; break;
                case 'b': st[rt] = B; break;
...
inline void solve(){
    A.a[0][0] = 1; A.a[1][0] = INF; A.a[2][0] = INF;
    A.a[0][1] = 0; A.a[1][1] = 0; A.a[2][1] = INF;
    A.a[0][2] = INF; A.a[1][2] = 1; A.a[2][2] = 0; 

    B.a[0][0] = 0; B.a[1][0] = INF; B.a[2][0] = INF;
    B.a[0][1] = 1; B.a[1][1] = 1; B.a[2][1] = INF;
    B.a[0][2] = INF; B.a[1][2] = 0; B.a[2][2] = 0; 

    C.a[0][0] = 0; C.a[1][0] = INF; C.a[2][0] = INF;
    C.a[0][1] = 1; C.a[1][1] = 0; C.a[2][1] = INF;
    C.a[0][2] = INF; C.a[1][2] = 1; C.a[2][2] = 1; 
    n = read(), q = read();
    scanf("%s", s + 1);
    st.build();
    while(q--) {
        ...
        st.update(a, c);
        node ans = st.query(1, n);
        print(min({ans.a[0][0], ans.a[0][1], ans.a[0][2]}), '\n');
    }
}
