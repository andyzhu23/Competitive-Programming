...
struct node {
    ...
    node operator+(const node& o) const {
        ...
        ans.l = l;
        ans.r = o.r;
        ans.val = val * p[len] + o.val;
        ans.val2 = (val2 * p2[len] % mod + o.val2) % mod;
        return ans;
    }
    bool operator==(const node& o) const {
        return val == o.val && val2 == o.val2;
    }
} st[N << 2];
...
inline void solve(){
    ...
    while(q--) {
        ...
        if(opt == 1) {
            ...
            print(query(1, 1, n, l1, r1) == query(1, 1, n, l2, r2), '\n');
        } else {
            int i = read(), v = read();
            update(1, 1, n, i, v);
        }
